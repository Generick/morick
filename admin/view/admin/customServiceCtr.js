...
var customServiceCtr = {
    ...
    getTenantList : function(){
        ...
        pageController.pageInit(self.scope, api.API_GET_CUSTOMSERVICE_LIST, {},
...
//          	console.log(JSON.stringify(data))
                ...
                self.goodsModel.tenantList = data.serviceList;
    ...
    bindEvent : function(){
    	...
    	self.scope.addTenant = function(title){
            ...
            yes: function(index){
	    		...
	    		$data.httpRequest("post", api.API_ADD_CUSTOMSERVICE, params, function(){
	                self.getTenantList();
	                layer.close(self.goodsModel.showIndex);
	                layer.msg("添加客服成功！", {time: 1600, anim: 5});
    	...
    	self.scope.deleteTenant = function(){
    	    ...
    	    if(arr.length == 0)
    	    {
    	    	 layer.msg("请选择客服！", {time: 1600, anim: 5});
    	    	 return;
    	    }
    	    var params = {};
    	    params.ids = JSON.stringify(arr);
    		$data.httpRequest("post", api.API_DEL_CUSTOMSERVICE, params, function(){
                self.getTenantList();

                layer.msg("删除客服成功！", {time: 1600, anim: 5});
            })
    	};
...
//  		alert(JSON.stringify(item))
            ...
            yes: function(index){
               self.goodsModel.showIndex = index;
    			...
    			$data.httpRequest("post", api.API_MOD_CUSTOMSERVICE, params, function(){
                	self.getTenantList();
