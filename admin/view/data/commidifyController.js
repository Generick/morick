...
var commidifyDeleteController = {
	...
	getDataList : function(){
		...
		pageController.pageInit(self.scope, api.API_GET_DELETE_COMMIDIFYLIST,params,
            /**
             * @param data.count
            ...
            function(data){
                ...
                else
                {
	                ...
	                {    
	                	self.objectList[i].pic = JSON.stringify(self.objectList[i].commodity_pic)[0];
	                    if(self.objectList[i].commodity_pic.substr(0,1) == "[")
	                	{
	                		self.objectList[i].pic = JSON.parse(self.objectList[i].commodity_pic)[0];
	                	}
	                	else{
	                		self.objectList[i].pic = self.objectList[i].commodity_pic;
	                	}
